                    ...
                    <table class="table mb-0 text-nowrap varient-table align-middle fs-3">
                      <thead>
                        <tr>
                          ...
                          <th scope="col" class="px-3 text-muted">Child Name</th>
                          <th scope="col" class="px-3 text-muted">Vaccine</th>
                          <th scope="col" class="px-3 text-muted">Hospital</th>
                        ...
                        <?php while ($row = mysqli_fetch_assoc($result)) { ?>
                          <tr>
                            ...
                            <td class="px-3">
                              ...
                              elseif ($row['status'] === 'Vaccinated') echo "<span class='badge bg-success'>Vaccinated</span>";
                              else echo "<span class='badge bg-danger'>Missed</span>";
                              ?>
                            </td>
                          </tr>
                        <?php } ?>
